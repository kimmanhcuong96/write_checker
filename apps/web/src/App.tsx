    ...
    {sitePath === "/admin"
      ...
      : sitePath === "/about" || sitePath === "/contact" || sitePath === "/privacy"
        ...
        <nav id="features" className="feature-navigation" aria-label="Writing features">
          <section id="writing-checker" className={workspaceMode === "checker" ? "active" : undefined}><h2><a href={featureHref("checker")} aria-current={workspaceMode === "checker" ? "page" : undefined}>Writing checker</a></h2><p>Get CEFR-aligned feedback for your own English draft.</p></section>
          <section id="writing-practice" className={workspaceMode === "topic" ? "active" : undefined}><h2><a href={featureHref("topic")} aria-current={workspaceMode === "topic" ? "page" : undefined}>Writing practice</a></h2><p>Write from guided general and IELTS-style topics.</p></section>
          <section id="exam-practice" className={workspaceMode === "exam" ? "active" : undefined}><h2><a href={featureHref("exam")} aria-current={workspaceMode === "exam" ? "page" : undefined}>Exam practice</a></h2><p>Complete IELTS and TOEIC writing practice tasks.</p></section>
        </nav>
